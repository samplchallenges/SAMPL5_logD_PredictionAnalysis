...
%DLM: I'm not seeing where the "thanks" appears. Here's my standard acknowledgments, and let's actually retain the NIH acknowledgment here as this is somewhat related, plus they provide some of my support
...
%DLM: Also we should be sure in acknowledgments to acknowledge everyone who was helpful in any way - i.e. Andreas Klamt surely should be acknowledged, as well as probably Frank Pickard, and possibly people from Schrodinger. Is there anyone else who helped? i.e. did we run into OpenEye bugs and get help from them, or...? 
%DLM: Also should acknowledge D3R support (their NIH grant). Let me ask Gilson.
...
%DLM: Need to get departments in here somewhere - I'm PharmSci and Chem, you're Chem, Kalli is PharmSci.
...
%DLM: Should be able to pull these from e-mails. Let me know if you need help.
