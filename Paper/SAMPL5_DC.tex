...
Eight submissions from two participants included results for only batch 0, and an additional five submissions from two participants provided only batch 0 and batch 1.
