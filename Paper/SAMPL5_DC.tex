...
We also included post-challenge analysis of protonation and tautomeric states and used this to convert our calculated partition coefficients to distribution coefficients.
...
The input, results, molecular dynamics parameter and corodinate files, and tables of solvation free energies are available in the supporting information. 
...
In the second set, we calculated a correction for the bias (treated as a simple offset) between the calculated XlogP values and a set of experimental cyclohexane/water partition coefficients \cite{Leo:1971wu}.
