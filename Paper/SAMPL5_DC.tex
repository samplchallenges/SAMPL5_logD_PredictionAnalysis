...
when the specifications and input files for the challenge were made available on the D3R website (http://drugdesigndata.org); these are also provided in the supporting information, made available on the University of California Dash at % URL
...
Separate analysis for dat subsets is available in the supporting information on Dash
...
The input, results, molecular dynamics parameter and corodinate files, and tables of solvation free energies are available in the supporting information on Dash.
...
It should be noted, that the water molecules spend the entire production phase next to the solute, so in general the local concentration of water near the solute may be higher than the bulk concentration in cyclohexane.
...
Supporting information is available free of charge online through the University of California Dash at  % DASH website URL
