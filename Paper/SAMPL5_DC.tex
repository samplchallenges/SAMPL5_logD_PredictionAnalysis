...
%DLM: Yes, you can't measure correlation/rank ordering if all of your calculated values are the same. :) 
...
$XlogP_{oct}$ would be in the top few submissions by tau and R, but ranked in the middle by all other metrics (Table \ref{otherPredictions}). % table ref
