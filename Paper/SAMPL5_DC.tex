...
No two solvents are perfectly immiscible. 
To explore the change in computed solvation free energy into cyclohexane with water present
...
\hline
$\Delta G_{hydration}$ & \multicolumn{3}{|c|}{$ -21.90 \pm 0.04 $} \\
...
\end{tabular}
\label{waterInCyc}
\caption{Shown are results for solvation free energy and distribution coefficient for SAMPL5\_074 in cyclohexane with no water present, 1 water molecule, and 7 water molecules all with 150 cyclohexane molecules and 1 solute molecule. Energy is reported in $kcal/mol$} 
\comment[CCB]{new caption}
\end{table}
...
The first simulation contained 7 water molecules and the second had 1 water molecule, with 1 solute molecule and 150 cyclohexane molecules. 
While neither of these results reach the low experimental concentration of water in cyclohexane, they do demonstrate the dramatic variation in solvation free energy caused by the presence of water in cyclohexane. 
With varying amounts of water in cyclohexane, it results in a significant changes in the computed solvation free energy for SAMPL5\_074 into cyclohexane with water (Table \ref{waterInCyc}). 
...
In visualizing both trajectories for the production phase, all water molecules stay next to SAMPL5\_074 for the full simulation. 
We would expect that the addition of a second solvent would caused increased uncertainty in the solvation free energy due to the more mixed states; the continued proximity of water to the solute likely accounts for the lack of change in the calculated uncertainty. 
For a solute with so many polar functional groups, it is unsurprising that the water molecules in cyclohexane are drawn to the solute. 
...
The concentration of water in cyclohexane for these simulations are 0.0067 and 0.047 for 1 and 7 water molecules, both an overestimation of the amount of water in cyclohexane. 
...
To accurately account for these affects simulations would need significantly larger box sizes to match the experimental water concentration. 
...
\comment[CCB]{this sort of just ends, another concluding sentence might be good}
