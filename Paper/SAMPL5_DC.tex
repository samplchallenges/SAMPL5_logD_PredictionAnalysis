...
\section{Submissions from the Mobley Group} %DLM: Let's say "Standard calculations from the Mobley group"
\label{methods:1}
...
%DLM: Except for the use of hash keys as submission IDs. ;) 
...
all input files and results files for 'logP' calculations, tautomer redos, box size simulations (PME too?)  %DLM: What's the "PME too" part?
