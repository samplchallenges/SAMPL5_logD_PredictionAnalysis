...
The Drug Design Data Resource (D3R), organizers for SAMPL5, settled on cyclohexane-water distribution coefficients, and thanks to a partnership with Genentech, this led to a series of measurements on drug-like compounds, discussed in detail in this issue \cite{Rustenburg:sampl5}.
...
. It may also provide commentary on the dataset, which contains a reasonably large percentage of $\log D$ values that are not that far off from zero.
...
\begin{tabular}{| l | r r |}
\hline
& Dry Cyclohexane & Water in Cyclohexane \\
\hline
...
Overall, the results of this challenge strongly suggest predictions for solute partitioning will be extremely helpful for driving improvements to physical modeling needed in pharmaceutical research. % I didn't want both sentences to end in drug design...
...
Specifically, protonation states and tautomeric states were found to be difficult to predict and are potentially dependent on environment with different populations in each solvent. 


, uncertain, and potentially environment-dependent in ways that can dramatically affect computed properties, and 
...
Thus, overall, distribution coefficients have been an extremely valuable part of this year's SAMPL5 challenge, and, since they can be measured in a relatively straightforward way, seem to be a promising potential source of future data for blind challenges.  
